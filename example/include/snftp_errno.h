...
#define SDFS_STAT_INUM                  (0x80002001)


#define SDFS_CREATE_NAME_EMPTY          (0x80003001)
#define SDFS_CREATE_NAME_LONG           (0x80003002)
#define SDFS_CREATE_TYPE                (0x80003003)
...
#define SDFS_UNLINK_NAME_EMPTY          (0x80006001)
